...
### Descripción
En la columna de la tabla de nombre `Column`{style="color:white"}  se lista el nombre de las siete variables en `penguins`. El significado de las variables es el siguiente:
