...
np.float64(6300.0)
```
En el segundo caso `np.float64`{style="color:white"}  solo informa del formato de representación del resultado (punto flotante de doble precisión), y puedes ignorarlo. 
:::
